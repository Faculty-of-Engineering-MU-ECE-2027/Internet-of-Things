...
| Topic                                | Resources                                                                                                     |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------------- |
| 🔌 **IoT Fundamentals**              | 📖 [AWS – How AWS IoT Works](https://docs.aws.amazon.com/iot/latest/developerguide/aws-iot-how-it-works.html) |
...
| 💻 **C/C++ Fundamentals**            | 🎓 [LearnCpp](https://www.learncpp.com/)                                                                      |
| 🧠 **Embedded Systems Fundamentals** | 📖 [Embedded Systems – ARM Education](https://www.arm.com/resources/education)                                |
| 🤖 **Arduino Fundamentals**          | 📖 [Arduino Documentation](https://docs.arduino.cc/)                                                          |
| 🧪 **Arduino Projects**              | 📖 [Arduino Tutorials](https://docs.arduino.cc/tutorials/)                                                    |
| 🔧 **Sensors & Actuators**           | 📖 [Arduino Documentation](https://docs.arduino.cc/)                                                          |
| 🟦 **ESP32 Fundamentals**            | 📖 [Espressif – ESP32 Documentation](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/)            |
| 🛠️ **ESP-IDF**                      | 📖 [ESP-IDF Programming Guide](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/get-started/)      |
| 🌐 **Networking Fundamentals**       | 🎓 [Cisco Networking Basics](https://www.netacad.com/courses/networking-basics)                               |
| 🐧 **Linux Fundamentals**            | 🎓 [Linux Journey](https://linuxjourney.com/)                                                                 |
